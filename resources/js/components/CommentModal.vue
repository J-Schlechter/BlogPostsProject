  ...
  <div class="modal is-active">
    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        ...
        <!-- Add new comment -->
        <div>
          <textarea lass="textarea  has-fixed-size" style="width: 400px; height: 150px; resize: none;" v-model="newComment" type="text" placeholder="Add a new comment" />
          
          <button class="button is-success" @click="addNewComment">Add Comment</button>
        </div>
      </section>
    </div>
  </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const sortedComments = computed(() => {
      return props.comments.slice().sort((a, b) => new Date(b.created_at) - new Date(a.created_at));
    });
